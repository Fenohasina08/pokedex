...
const Home = () => {
    ...
    return (
        <div className="bg-[#FCEE] min-h-screen relative">
            {/* Barre de recherche fixée et centrée */}
            <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-[90%] max-w-[600px]">
                <input
                    ...
                    className="w-full px-4 py-2 rounded-md border border-gray-300 shadow-md focus:outline-none focus:ring-2 focus:ring-amber-600"
                />
            </div>
